    ...
    var arrtitle=["H5推广：你该知道的一些事儿", 
        ...
        "SVG 实现复杂线条动画",
         ...
         "图片资源 Base64 化在 H5 页面里有用武之地吗",
          ...
          "前端HTML5几种存储方式的总结"]
    var arrlink=["http://web.jobbole.com/90701/", 
...
for (var i = 0; i<arrtitle.length;i++){
   for (var i = 0;i<arrlink.length;i++){
    strhtml += '<a href="'+arrlink[i]+'" > '+arrtitle[i]+' </a><br>'
   }
} 
document.getElementsByClassName('title-link')[0].innerHTML=strhtml